...
import com.olnc.made.homenap.api.MigrationHandlerManagerItf;
import com.olnc.made.homenap.utils.Service;
import com.olnc.made.homenap.utils.StatefulComponent;
...
public class MigrationManager implements MigrationHandlerManagerItf
{
    ...
    public Map<String, Object> registerComponent(Long bundleId, String instanceName)
    {
        ...
        Service service = serviceInfoDBItf.get(bundleId);
